# Information
This is a cool animation that could be used for timing your MU calibrations so you don't have to VR or travel to see calibration status. Can have multiple other uses as well. Turn screen off then back on to reset.
> **Note**
...
![Image of Screen](DU-Scroll-Timer.gif?raw=true)
