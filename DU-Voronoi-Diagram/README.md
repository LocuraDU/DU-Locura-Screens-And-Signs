# Information
This is a cool animation that could be used for an organization, ship, or store logo or even a background.
...
![Image of Screen](DU-Voronoi-Diagram.png?raw=true)
